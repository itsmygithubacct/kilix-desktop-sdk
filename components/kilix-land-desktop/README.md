...
Design document: `~/research/gpu_terminal/kilix-land-desktop/IMPLEMENTATION.md`.
...
KILIX_DESKTOP_COMMAND=cd ~/gpu_terminal/kilix-land-desktop && exec ./kilix-land-desktop
